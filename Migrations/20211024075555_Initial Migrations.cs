    ...
    public partial class InitialMigrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRolesDb", x => x.RoleID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleRegisterNumber = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_UsersDb_UserID",
                        column: x => x.UserID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateLocationTimeStamp = table.Column<DateTime>(type: "datetime", nullable: false),
                    DeviceID = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
